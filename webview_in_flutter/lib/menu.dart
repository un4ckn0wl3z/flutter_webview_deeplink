      ...
      builder: (context, controller) {
        return PopupMenuButton<_MenuOptions>(
          onSelected: (value) async {
            switch (value) {
              case _MenuOptions.navigationDelegate:
                ...
                break;
              case _MenuOptions.callUnkClub:
                await controller.data!.loadUrl('https://unknownclub.net/');
                break;
              ...
              case _MenuOptions.javascriptChannel:
                ...
                //   req.send();''');
                await controller.data!.runJavascript('''
                  if (window.location.href.indexOf("unknownclub.net") != -1){
                    SnackBar.postMessage("success");
                  }
                  ''');
                break;
          ...
          itemBuilder: (context) => [
            ...
            const PopupMenuItem<_MenuOptions>(
              value: _MenuOptions.callUnkClub,
              child: Text('callUnkClub'),
            ),
          ],
        );
      },
...
// https://youtu.be/FrqGGw9DYfs?t=1819
